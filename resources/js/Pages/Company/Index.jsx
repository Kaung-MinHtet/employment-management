    ...
    const columns = [
        ...
        { field: "logo", headerName: "Logo", width: 150, renderCell: (params) => {
            if(params.row.logo != null) {
                return (
                    <img src={window.location.origin + "/storage/" + params.value} alt="Company Logo" className="w-10 h-10 rounded-full" />
                )
            } else {
                return "";
            }
            ...
            {showModal && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
                    <div className="bg-white p-6 rounded-md">
                        <h3 className="text-lg font-semibold mb-4">Are you sure you want to delete this company?<br/><span className="font-normal text-base text-center block text-gray-600">Employees in this company will also be deleted.</span></h3>
